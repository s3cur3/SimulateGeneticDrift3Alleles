...
plot "output/frequency_over_time3.tsv" using 1:4 w l ls 1
plot "output/frequency_over_time3.tsv" using 1:3 w l ls 2
plot "output/frequency_over_time3.tsv" using 1:2 w l ls 3
